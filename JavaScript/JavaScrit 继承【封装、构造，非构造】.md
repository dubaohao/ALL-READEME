# JavaScrit 继承【封装、构造，非构造】

作者：阮一峰

[1.Javascript 面向对象编程（一）：封装](#1Javascript-面向对象编程一封装)

[2.Javascript面向对象编程（二）：构造函数的继承](#2Javascript面向对象编程二构造函数的继承)

[3.Javascript面向对象编程（三）：非构造函数的继承](#3Javascript面向对象编程三非构造函数的继承)
